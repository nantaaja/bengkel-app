...
export default function ServiceHeader({ onAdd }) {
  return (
    <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between mb-6 mt-3">
      <div>
        <h1 className="text-2xl sm:text-4xl font-semibold tracking-tight text-white">Daftar Pelayanan Servis</h1>
        <p className="mt-2 text-sm sm:text-base text-zinc-400">Kelola seluruh transaksi pelayanan servis bengkel.</p>
      </div>
      <button
        onClick={onAdd}
